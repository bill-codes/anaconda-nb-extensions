...
def install(enable=False, disable=False, **kwargs):
    ...
    **kwargs: keyword arguments
    ...
    if disable:
        ...
        if "locker.nbextension" in server_extensions:
            server_extensions.remove("locker.nbextension")
        ...
        if "locker/main" in nb_extensions:
            cfg["load_extensions"].pop("locker/main")
